...
@click.option("--primers", help="Path to file for repeats motifs for each loci", default=None)
...
def main(project, loci, clean):
    project = "/Users/elena/PycharmProjects/ngs_pipelines/DAB053" #user input
    primers = "/Users/elena/PycharmProjects/ngs_pipelines/DAB053/UA_primers.csv" #user input
   ...
   # Read table with motif data and add columns with necessary data for allele calling if absent.
    ...
    for lib in tab_dirs:
        ...
        for t in tabs:
            ...
            gen = gen[gen["Read_Count"] >= 5] #filter out samples with number of reads < 5
